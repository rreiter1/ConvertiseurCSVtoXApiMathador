...
public class GenStatement {
	...
	private String idApplicationModeChrono = "29f6f4d0cb77aa4f951a1ee15c521bb7"; //idApplication qui correspond au mode chrono
	...
	public Statement Started()
	{
		...
		if(this.epreuve.getIdApplication().equals(idApplicationModeChrono))
		{
